...
<html lang="zh-cn">
  ...
  <body>
    <div class="maincont">
     <div class="userName">
      <dl class="names">
       <dt><img src="http://www.uploads.com/uploads/20190313/N52UycHaJc8fXPnlpG6x0GbCl0jHaNCOU98FXGks.png" /></dt>
       <dd>
        <p>@if(session('user')!=="")<span  style="color:#ffff00;"><?php echo session('user.email')?></span>@endif</p>
       </dd>
     ...
     <ul class="userNav">
      ...
      <li><span class="glyphicon glyphicon-star-empty"></span><a href="/Goods/shoucang">我的收藏</a></li>
      <li><span class="glyphicon glyphicon-heart"></span><a href="/Goods/browse">我的浏览记录</a></li>
      <li><span class="glyphicon glyphicon-usd"></span><a href="/Goods/tixian">余额提现</a></li>
	 </ul><!--userNav/-->
